        ...
        <div className="flex min-h-screen items-center justify-center p-4">
            <div className="glass-panel w-full max-w-md space-y-8 p-10 hover-lift active:scale-[0.99] transition-transform">
                ...
                <form onSubmit={handleAuth} className="space-y-6">
                    ...
                    {error && <div className="rounded-2xl border-2 border-red-300 bg-red-100 p-4 text-xs font-black text-red-900 dark:bg-red-500/10 dark:border-red-500/20 dark:text-red-400 flex items-center gap-2"><span className="h-3 w-3 rounded-full bg-red-600" />{error}</div>}
                    {message && <div className="rounded-2xl border-2 border-emerald-300 bg-emerald-100 p-4 text-xs font-black text-emerald-900 dark:bg-emerald-500/10 dark:border-emerald-500/20 dark:text-emerald-400 flex items-center gap-2"><span className="h-3 w-3 rounded-full bg-emerald-600" />{message}</div>}
                ...
                <div className="text-center">
                    <Link href="/" className="text-xs font-bold text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors">
                        ← Back to home
                    </Link>
                </div>
            </div>
