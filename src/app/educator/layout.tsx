  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside className="glass-panel hidden w-64 border-r-2 border-slate-900 p-6 lg:block !rounded-none !border-y-0 !border-l-0 bg-white dark:bg-slate-900/90">
        <div className="mb-10">
          <Link href="/educator" className="text-2xl font-black">
        ...
        <nav className="space-y-2">
          <Link
            href="/educator"
            className="block rounded-xl px-4 py-2.5 text-sm font-black text-slate-900 dark:text-slate-300 transition-all hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-violet-900 dark:hover:text-violet-400"
          >
            Dashboard
          </Link>
          <Link
        ...
        <header className="glass-panel !rounded-none !border-x-0 !border-t-0 border-b-2 border-slate-900 p-4 sticky top-0 z-10 bg-white dark:bg-slate-900/90">
          <div className="flex items-center justify-between">
            <div className="lg:hidden">
              <Link href="/educator" className="text-xl font-black">
                <span className="gradient-text">Unmask</span>
              </Link>
            </div>
            <div className="flex items-center gap-4">
              <span className="rounded-full border-2 border-slate-900 bg-violet-500/10 px-4 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-violet-900 dark:text-violet-300">
                Educator Expert
              </span>
            </div>
          </div>
